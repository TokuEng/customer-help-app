...
from routers import search, articles, feedback, revalidate, rag, ingestion, admin, analytics, ai_render, admin_panel, visa
...
app.include_router(visa.router, prefix=f"{settings.api_prefix}/admin")
